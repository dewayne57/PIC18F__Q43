...
#define APP_VREF_MV 5000UL
#define ADCC_MAX_COUNTS 4095UL
#define DAC_MAX_COUNTS 255UL

// Conversions with rounding.
#define ADCC_MV_TO_COUNTS(mv) ((((unsigned long)(mv) * ADCC_MAX_COUNTS) + (APP_VREF_MV / 2UL)) / APP_VREF_MV)
#define ADCC_COUNTS_TO_MV(counts) ((((unsigned long)(counts) * APP_VREF_MV) + (ADCC_MAX_COUNTS / 2UL)) / ADCC_MAX_COUNTS)
#define DAC_MV_TO_COUNTS(mv) ((((unsigned long)(mv) * DAC_MAX_COUNTS) + (APP_VREF_MV / 2UL)) / APP_VREF_MV)
...
// DAC ladder behavior.
#define DAC_LADDER_MIN_MV 0U
#define DAC_LADDER_MAX_MV 5000U
#define DAC_LADDER_STEP_MV 100U
#define DAC_STEP_PERIOD_MS 1000U

// Route DAC output to the DAC1OE[2:0] output selection that maps to AN1 on this design.
#define DAC1_OUTPUT_TO_AN1 0b010U
