...
function(PPSLIB_default_default_XC8_assemble_rule target)
    set(options
        "-c"
        "${MP_EXTRA_AS_PRE}"
        "-mcpu=18F47Q43"
    ...
    target_include_directories(${target} PRIVATE "${CMAKE_CURRENT_SOURCE_DIR}/../../../../../Libraries/PPSLIB")
endfunction()
function(PPSLIB_default_default_XC8_assemblePreprocess_rule target)
    set(options
        "-c"
        "${MP_EXTRA_AS_PRE}"
        "-mcpu=18F47Q43"
...
function(PPSLIB_default_default_XC8_compile_rule target)
    set(options
        "-c"
        "${MP_EXTRA_CC_PRE}"
        "-mcpu=18F47Q43"
...
function(PPSLIB_default_archiver_rule target)
    set(options
        "--target"
        "18F47Q43"
        "${MP_EXTRA_AR_PRE}"
