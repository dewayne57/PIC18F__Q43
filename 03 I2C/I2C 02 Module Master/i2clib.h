...
typedef enum
{
    I2C_MODE_MASTER_7BIT = 0,   // Master mode with 7-bit addressing
    I2C_MODE_MASTER_10BIT,      // Master mode with 10-bit addressing
    I2C_MODE_SLAVE_7BIT,        // Slave mode with 7-bit addressing
    I2C_MODE_SLAVE_10BIT,       // Slave mode with 10-bit addressing
    I2C_MODE_MULTI_MASTER_7BIT, // Multi-master mode with 7-bit addressing
    I2C_MODE_MULTI_MASTER_10BIT // Multi-master mode with 10-bit addressing
} i2c_mode_t;
...
/// configures the I2C peripheral according to the specified mode (e.g., master
/// or slave) and selects the appropriate channel if multiple channels are supported.
...
/// @brief This function is used by slave devices to send data back to the master
