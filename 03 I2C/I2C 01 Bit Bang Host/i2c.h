/* *****************************************************************************************
 *   File Name: i2c.h
 *   Description: Bit bang I2C host implementation for PIC18F47Q43.
 ...
 * 
 *   This example uses an MCP23017 I/O expander as the I2C client device, with Port A connected
 ...
 *   an interrupt is triggered.  The host will read the state of the MCP23017's GPIOA pins
...
/// @brief I2C host handle structure to manage I2C state and configuration
typedef struct {
...
typedef enum {
    ...
    I2C_ERROR_TIMEOUT = 1,      ///< Bus timeout (client holding clock low)
    I2C_ERROR_NAK = 2,          ///< No acknowledge received from client
    I2C_ERROR_NOT_INITIALIZED = 3 ///< I2C interface not initialized
} i2c_status_t;

/// @brief Initialize the I2C bit bang host interface
...
/// @brief Deinitialize the I2C bit bang host interface
/// @param handle Pointer to i2c_handle_t structure
/// @return i2c_status_t indicating success or error
...
/// @brief Probe whether a client acknowledges its address on the I2C bus
/// @param handle Pointer to i2c_handle_t structure
/// @param address I2C client address byte with R/W bit clear in bit 0
...
/// @param handle Pointer to i2c_handle_t structure
/// @param address I2C client address (R/W bit will be set by the function)
