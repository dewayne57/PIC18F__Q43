...
## Overview
This project implements an I2C host in software (bit bang) on PIC18F47Q43 using GPIO pins RC3 (SCL) and RC4 (SDA). It communicates with an MCP23017 I/O expander, mirrors Port A switch inputs to Port B LEDs, and reports configuration changes over UART.

## Peripheral Focus
- GPIO-based bit-bang I2C host
