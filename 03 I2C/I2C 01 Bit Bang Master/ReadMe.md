...
## Overview
This project implements an I2C master in software (bit bang) on PIC18F47Q43 using GPIO pins RC3 (SCL) and RC4 (SDA). It communicates with an MCP23017 I/O expander, mirrors Port A switch inputs to Port B LEDs, and reports configuration changes over UART.

## Peripheral Focus
- GPIO-based bit-bang I2C master
...
- Device: PIC18F47Q43
- I2C SCL: RC3 (open-drain with pull-up)
- I2C SDA: RC4 (open-drain with pull-up)
...
## Behavior
- Initializes software I2C and configures MCP23017 in banked mode.
...
- `config.c`: oscillator, port setup, PPS, and INT1 configuration.
- `i2c.c`/`i2c.h`: bit-bang I2C implementation.
