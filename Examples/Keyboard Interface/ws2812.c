...
#define WS2812_PWM_PERIOD_TICKS      19U
#define WS2812_PWM_PERIOD_COUNTS     (WS2812_PWM_PERIOD_TICKS + 1U)
#define WS2812_DUTY_0_TICKS          ((uint8_t)((WS2812_PWM_PERIOD_COUNTS * 30U) / 100U))
#define WS2812_DUTY_1_TICKS          ((uint8_t)((WS2812_PWM_PERIOD_COUNTS * 70U) / 100U))
