...
#define LM75_I2C_ADDRESS 0x90 // 7-bit I2C address for the LM75 temperature sensor 
#define LM75_ALARM_THRESHOLD_C 30 // Temperature threshold in °C for the LM75 alarm (set to 30°C for demonstration)
#define LM75_HYSTERESIS_C 27 // Hysteresis in °C for the LM75 alarm (set to 27°C for demonstration)
