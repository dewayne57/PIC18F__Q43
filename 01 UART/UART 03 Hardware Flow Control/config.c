...
void SYSTEM_Initialize(void)
{
    ...
    /* ANSEL registers select analog (1) vs digital (0) mode for each pin.
       Clear them all so the UART and flow-control pins on Port B work as digital I/O.
       Ports C and D are cleared too - no analog signals are used in this project. */
    ANSELB = 0x00;  // Port B pins: digital mode (includes TX, RX, RTS, CTS)
